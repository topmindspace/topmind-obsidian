...
export const zhCN = {
  ...
  // ── AI Chat ──
  chat_title: "AI 对话",
  chat_placeholder: "问点什么… Enter 发送，Shift+Enter 换行（输入法选词不会发出）",
  chat_send: "发送",
  chat_stop: "停止",
  chat_stopped: "已停止",
  ...
  settings_timeline_order_desc: "最新的一天在前；同一天内较晚的在前，同一时刻的一批保持记下的先后",
  ...
  notice_executed: "已执行",
  notice_fuzzy_matched: "（相似命中：{{fact}}…）",
  ...
  memory_browse_scope: "全部把画像、周期反思和专题记忆叠在一起，不含历史。页面变长通常是同类事实被反复追加，不是把动态原文拼进来。",
