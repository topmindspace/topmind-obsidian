...
export const enUS: typeof zhCN = {
  ...
  // ── AI Chat ──
  chat_title: "AI Chat",
  chat_placeholder: "Ask something… Enter to send, Shift+Enter for a new line (IME confirm will not send)",
  chat_send: "Send",
  chat_stop: "Stop",
  ...
  settings_timeline_order_desc: "Newest day first. Within a day, later times come first; notes from the same minute stay in the order you wrote them.",
  ...
  notice_fuzzy_matched: " (matched similar: {{fact}}…)",
  ...
  memory_browse_scope: "All stacks profile, period reflections, and topic memory. History stays on its own chip. A long page is repeated facts, not the stream pasted in.",
  ...
  notice_polish_failed: "AI polish failed",
  chat_btn_copy: "Copy",
